...
const TestimonialCard = ({
  ...
  return (
    <div className="relative rounded-md after:absolute after:top-[6px] after:rounded-md after:-left-0 after:rounded-es after:w-[99%] after:h-0 after:bg-PrimaryColor-0 after:-z-10 group after:transition-all after:duration-500  hover:after:h-full pl-[6px] hover:shadow-cases transition-all duration-500">
      <div className="px-10 pt-8 pb-9 bg-[#002526] relative bg-HoverColor-0 group rounded-md z-10 overflow-hidden before:absolute before:top-0 before:left-1/2 before:w-0 before:h-full before:bg-SecondaryColor-0 before:-z-10 before:rounded-md before:transition-all before:duration-500 hover:before:w-full group-hover:before:left-0 transition-all duration-500">
        ...
        <ul className="absolute top-10 right-10 rounded-full flex gap-2 py-3 bg-HeadingColor-0 transition-all duration-500 group-hover:bg-PrimaryColor-0 px-[30px] justify-center items-center">
