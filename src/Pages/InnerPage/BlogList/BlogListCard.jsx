  ...
  return (
    <div className="border border-BorderColor-0 rounded-md overflow-hidden group">
      <div className="relative overflow-hidden">
        ...
        />
        <h6 className="font-AlbertSans text-white px-5 py-2 rounded absolute top-5 -left-1/4 transition-all duration-500 bg-SecondaryColor-0 group-hover:left-5">
          {thumbContent}
        </h6>
      </div>
      ...
      <div className="border-t border-BorderColor-0 py-5 px-4 sm:px-8">
        <Link to={blogListUrl}>
          <button
            className="font-AlbertSans font-medium text-HeadingColor-0 flex gap-2 items-center transition-all duration-500 hover:text-SecondaryColor-0 relative before:absolute before:bottom-0 before:right-0 before:w-0 before:h-[1px] before:bg-SecondaryColor-0 before:transition-all
