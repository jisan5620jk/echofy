            ...
            <div className="col-span-2">
              <div className="border border-BorderColor-0 rounded-md overflow-hidden">
                <div className="relative">
                  ...
                  <h6 className="font-AlbertSans text-white px-5 py-2 rounded absolute top-5 left-5 bg-SecondaryColor-0">
                    Cleaning
                  </h6>
                </div>
                <div className="px-4 sm:px-8">
                  <Link to={"/"}>
                    <button className="font-AlbertSans font-bold text-left text-lg sm:text-2xl 2xl:text-3xl text-HeadingColor-0 transition-all duration-500 hover:text-SecondaryColor-0 mt-9 mb-6">
                  ...
                  <div className="flex flex-col bg-[#f3f4f8] sm:flex-row gap-7 px-4 sm:px-11 py-4 sm:py-10 rounded-md mt-12">
                    ...
                    <div className="flex-1">
                      ...
                      <h6 className="font-AlbertSans text-HeadingColor-0 pl-16 mt-4 relative before:absolute before:top-1/2 before:left-0 before:-translate-y-1/2 before:w-14 before:h-[1px] before:bg-SecondaryColor-0">
                        CEO & Founder
                      </h6>
                    </div>
                  </div>
                  <Link to={"/"}>
                    <button className="font-AlbertSans font-bold text-left text-xl sm:text-2xl md:text-3xl text-HeadingColor-0 transition-all duration-500 hover:text-SecondaryColor-0 mt-14 mb-4">
                  ...
                  <Link to={"/"}>
                    <button className="font-AlbertSans font-bold text-left text-xl sm:text-2xl md:text-3xl text-HeadingColor-0 transition-all duration-500 hover:text-SecondaryColor-0 mt-10 mb-4">
                ...
                <div className="flex flex-col sm:flex-row gap-5 items-start sm:justify-between border-t border-BorderColor1-0 mt-9 py-5 px-4 sm:px-8">
                  <div>
                    <h6 className="font-AlbertSans text-lg font-medium">
                      <Link to={"/"}>
                        <button className="font-AlbertSans font-normal text-sm px-5 py-2 text-HeadingColor-0 rounded bg-[#f3f4f8] transition-all duration-500 hover:bg-SecondaryColor-0 hover:text-white mr-2 ml-1">
                          Cleaning
                        </button>
                      </Link>
                      <Link to={"/"}>
                        <button className="font-AlbertSans font-normal text-sm px-5 py-2 text-HeadingColor-0 rounded bg-[#f3f4f8] transition-all duration-500 hover:bg-SecondaryColor-0 hover:text-white">
                          Washing
                        </button>
                      </Link>
                    </h6>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-7 mt-[60px]">
                <div className="rounded-md bg-[#f3f4f8] pt-8 pb-10 px-9">
                  <Link to={"/"}>
                    <button className="font-AlbertSans font-medium text-lg text-HoverColor-0 flex items-center gap-2">
            ...
            <div className="col-span-2 lg:col-span-1">
              ...
              <div className="bg-[#f3f4f8] rounded-md px-4 sm:px-8 lg:px-6 xl:px-8 pt-7 pb-4 mb-7">
                ...
                <ul className="mt-8">
                  <li>
                    <Link to={"/"}>
                      <button className="w-full font-AlbertSans text-left text-HeadingColor-0 transition-all duration-500 group px-7 py-4 flex items-center gap-2 rounded bg-white mb-3 overflow-hidden z-[1] relative before:absolute before:top-0 before:right-0 before:w-0 before:-z-[1] before:h-full before:bg-SecondaryColor-0 before:rounded before:transition-all before:duration-500 hover:before:w-full hover:before:left-0 hover:text-white">
                ...
                <Link to={"/blog-details"}>
                  <button className="group flex gap-4 mb-6">
                    ...
                    <div className="flex-1 text-left">
                      <h6 className="font-AlbertSans font-medium text-lg lg:text-base 2xl:text-lg leading-6 text-HeadingColor-0 transition-all duration-500 group-hover:text-SecondaryColor-0">
                        How to Proper Cleaning Floor Carpet
                      </h6>
                      <p className="font-AlbertSans text-SecondaryColor-0 text-sm mt-1">
                        01 Jan, 2024
                      </p>
                    </div>
                  </button>
