...
const ProjectDetails = () => {
  return (
    <>
      <BreadCrumb
        breadCrumbTitle={"House Floor Cleaning"}
        breadCrumbLink={"Project Details"}
        breadCrumbIcon={<FaArrowRightLong />}
        breadCrumbIcon2={<FaArrowRightLong />}
        breadCrumbContent={"House Floor Cleaning"}
      />
          ...
          <div className="grid grid-cols-3 gap-[70px]">
            <div className="col-span-3 lg:col-span-1">
              <div className="rounded-lg overflow-hidden bg-white mb-7">
                <h4 className="font-AlbertSans font-medium text-white text-2xl bg-SecondaryColor-0 pt-5 px-9 pb-5">
                  Project Details
                </h4>
              ...
              <div className="rounded-lg overflow-hidden bg-white mb-7 text-center pt-9 pb-6">
                ...
                <h6 className="font-AlbertSans font-semibold text-[22px] text-HeadingColor-0 mt-5 mb-1">
                  Abrahum Khan
                </h6>
                <p className="font-AlbertSans text-TextColor-0 font-light mb-7">
                  Maneger
                </p>
              ...
              <div className="rounded-lg px-9 overflow-hidden bg-[url('/images/widget-thumb.png')] bg-cover bg-no-repeat bg-center py-[50px]">
                ...
                <Link to={"/"}>
                  <button className="font-AlbertSans text-white flex items-center gap-2 mt-4 mb-[52px]">
                    <MdEmail className="text-xl text-SecondaryColor-0" />
                    example@gmail.com
                  </button>
                </Link>
                <Link to={"/"}>
                  <button className="font-AlbertSans text-white flex items-center gap-2 bg-SecondaryColor-0 w-full h-[58px] rounded-md justify-center">
                    Contact Us
                    <FaArrowRight />
                  </button>
                </Link>
            ...
            <div className="col-span-3 lg:col-span-2">
              ...
              <p className="font-AlbertSans font-light text-TextColor-0 mt-6">
              ...
              <p className="font-AlbertSans font-light text-TextColor-0 mt-7 mb-9">
              ...
              <div className="grid gap-7 grid-cols-1 lg:grid-cols-1 md:grid-cols-2 xl:grid-cols-2 mt-11">
                <div>
                  <h2 className="font-AlbertSans font-bold text-2xl sm:text-3xl text-HeadingColor-0">
                    Quickly Parallel Task
                  </h2>
