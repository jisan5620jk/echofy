          ...
          <div>
            ...
            <div className="flex justify-between">
              <ul>
                <li>
                  <Link to={"/"}>
                    <button className="flex items-center gap-2 font-AlbertSans text-white transition-all duration-500 hover:gap-1 mb-[18px] opacity-60  hover:!opacity-100">
                ...
                <li>
                  <Link to={"/"}>
                    <button className="flex items-center gap-2 font-AlbertSans text-white transition-all duration-500 hover:gap-1 opacity-60  hover:!opacity-100">
                      <FaChevronRight className="text-xs opacity-60 " />
                      Latest Blog
                    </button>
                  </Link>
