...
const TeamCard = ({teamThumb,teamTitle,teamDesignation,teamIcon,teamIcon2,teamIcon3,teamIcon4}) => {
  return (
    <div className="group">
      ...
      >
        <img src={teamShape} className="absolute bottom-1/4 left-1/4 animate-dance2 -z-10"/>
