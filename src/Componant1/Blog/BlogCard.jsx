    ...
    <div className="group transition-all duration-500 bg-white hover:shadow-cases rounded-md overflow-hidden">
      ...
      <div className="border-r border-l border-b rounded-b-md border-BorderColor2-0 transition-all duration-500 group-hover:border-x">
        <div className="px-5 sm:px-7 pt-6">
          ...
          <Link to={blogUrl}>
            <button className="font-AlbertSans text-left font-semibold text-xl sm:text-2xl lg:text-lg xl:text-2xl text-HeadingColor-0 transition-all duration-500 group-hover:text-PrimaryColor-0 mt-3 mb-3">
              {blogTitle}
            </button>
          </Link>
