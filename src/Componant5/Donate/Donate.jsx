    ...
    <section className="bg-[#e9ebea] py-[120px]">
      <div className="Container">
        <div className="grid grid-cols-3 gap-7">
          <div className="col-span-2 rounded-lg pl-[74px] pt-28 pb-[120px] bg-[url('/images/donate-thumb-1.png')] bg-no-repeat bg-cover bg-center">
            <h5 className="font-AlbertSans font-semibold text-PrimaryColor-0 flex items-center gap-2">
              <img src={subTitleShape} draggable="false" />
              OUR EVENTS
            </h5>
            <h1 className="font-AlbertSans font-bold text-[22px] leading-8 sm:text-[38px] sm:leading-[48px] md:text-[44px] md:leading-[54px] lg:text-[32px] lg:leading-[42px] xl:text-[40px] xl:leading-[50px] 2xl:text-[46px] 2xl:leading-[56px] text-white mt-[14px] mb-6">
            ...
            <p className="font-AlbertSans text-TextColor2-0">
              ...
              in the ethnic <br className="" /> PBR 3 wolf moon beard Helvetica.
              Salvia esse
            </p>
            <ul className="flex gap-3 my-11">
              <li>
          ...
          <div className="col-span-1 pl-10 rounded-lg bg-[url('/images/donate-thumb-2.png')] bg-no-repeat bg-cover bg-center flex items-center">
            <div>
              <h5 className="font-AlbertSans font-medium text-[17px] text-white">
                THE ANIMAL
              </h5>
              <h2 className="font-AlbertSans font-bold text-4xl text-white mt-2 mb-9">
