...
const ServiceCard = ({
  ...
  return (
    <div className="rounded-md bg-white text-center p-6 group relative z-10 before:absolute before:top-0 before:right-0 before:-z-10 before:w-0 before:h-full before:bg-SecondaryColor-0 before:transition-all before:duration-500 before:rounded-md hover:before:w-full hover:before:left-0 pr-7 mb-7 sm:mr-8 md:mr-0">
      ...
      <div>
        <h5 className="font-AlbertSans font-bold text-HeadingColor-0 text-xl sm:text-[22px] transition-all duration-500 group-hover:text-white pt-7 pb-3">
          {serviceTitle}
        </h5>
        <p className="font-AlbertSans text-TextColor-0 mb-8">{serviceDesc}</p>
        <Link to={serviceUrl} className="absolute -bottom-[25px] left-1/2 -translate-x-1/2">
